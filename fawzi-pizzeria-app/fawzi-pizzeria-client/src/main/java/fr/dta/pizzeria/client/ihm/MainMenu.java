...
import fr.dta.pizzeria.client.ihm.action.Action;
import fr.dta.pizzeria.client.ihm.action.AddPizza;
import fr.dta.pizzeria.client.ihm.action.DeletePizza;
import fr.dta.pizzeria.client.ihm.action.ExitMenu;
import fr.dta.pizzeria.client.ihm.action.ListPizza;
import fr.dta.pizzeria.client.ihm.action.ListPizzaFromCat;
import fr.dta.pizzeria.client.ihm.action.MigrateFilesToDB;
import fr.dta.pizzeria.client.ihm.action.ShowMostExpensivePizza;
import fr.dta.pizzeria.client.ihm.action.UpdatePizza;
